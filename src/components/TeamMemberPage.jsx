...
const TeamMemberPage = ({ memberId, memberName, role, description, skills, experience, education, bitacora, image, email, city, linkedin }) => {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-4">
                ...
                {linkedin && linkedin.trim() !== '' && (
                  <div className="flex items-center">
                    ...
                    <a href={linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-yellow-500 transition-colors duration-200">
                      LinkedIn
                    </a>
                  </div>
                )}
        ...
        {activeSection === 'bitacora' && (
          <div className="space-y-8">
            ...
            {bitacora.lifeMilestones && bitacora.lifeMilestones.trim() !== '' && (
              <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            {/* Hobbies */}
            {bitacora.hobbies && bitacora.hobbies.trim() !== '' && (
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h3 className="text-2xl font-semibold text-black mb-6 flex items-center">
                  <svg className="w-6 h-6 text-yellow-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {bitacora.coreInterests && bitacora.coreInterests.trim() !== '' && (
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h3 className="text-2xl font-semibold text-black mb-6 flex items-center">
                  <svg className="w-6 h-6 text-yellow-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {bitacora.personalEthics && bitacora.personalEthics.trim() !== '' && (
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h3 className="text-2xl font-semibold text-black mb-6 flex items-center">
                  <svg className="w-6 h-6 text-green-800 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
